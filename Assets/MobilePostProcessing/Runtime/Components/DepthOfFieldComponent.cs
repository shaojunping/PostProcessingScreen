...
namespace UnityEngine.PostProcessing
{
    ...
    public sealed class DepthOfFieldComponent : PostProcessingComponentRenderTexture<DepthOfFieldModel>
    {
        ...
        public void Prepare(RenderTexture source, Material uberMaterial)
        {
            ...
            //var colorFormat = RenderTextureFormat.Default;
            //var cocFormat = RenderTextureFormat.ARGB32;
            ...
            var rtCoC = context.renderTextureFactory.Get(context.width/2, context.height/2, 0, cocFormat);
            ...
            var rt1 = context.renderTextureFactory.Get(context.width / 4, context.height / 4, 0, colorFormat);
            material.SetTexture(Uniforms._CoCTex, rtCoC);
            Graphics.Blit(source, rt1, material, 2);

            // Bokeh simulation pass
            var rt2 = context.renderTextureFactory.Get(context.width / 4, context.height / 4, 0, colorFormat);
